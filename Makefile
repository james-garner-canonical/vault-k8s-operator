...
vendor-libs:
	rm -rf $(ROOT_DIR)/k8s/vendored/vault-package
	cp -r $(ROOT_DIR)/vault-package $(ROOT_DIR)/k8s/vendored/
	rm -rf $(ROOT_DIR)/machine/vendored/vault-package
	cp -r $(ROOT_DIR)/vault-package $(ROOT_DIR)/machine/vendored/
