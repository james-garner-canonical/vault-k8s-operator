...
class VaultCharmFixtures:
    ...
    patcher_vault_autounseal_manager = patch(
        "charm.VaultAutounsealManager", autospec=VaultAutounsealManager
    )
    ...
    def setup(self):
        ...
        self.mock_vault_autounseal_manager = (
            VaultCharmFixtures.patcher_vault_autounseal_manager.start().return_value
        )
